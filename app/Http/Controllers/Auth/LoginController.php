...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            ...
            if(!Auth::user()->email_verified_at) {
                ...
                Session::flush();
                return back()->withErrors([
                    'alert' => 'メールを確認してからログインしてください。',
                ]);
            }
            // create login history
            LogController::create(Auth::user()->id, 'login');
            // remind for the uncompleted recruitment
        ...
        return back()->withErrors([
            'alert' => '提供されたクレデンシャルは、当社の記録と一致しません。',
        ]);
    }
    ...
    {
//        $user = Auth::user();
        LogController::create(Auth::user()->id, 'logout');
